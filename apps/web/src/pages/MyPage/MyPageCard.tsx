...
function MyPageCard({backgroundUrl, num, count, title, path, width, height, x}:{backgroundUrl?:string, num:number, count:number, title:string, path:string, width:number, height:number, x:number}) {
    return (
