...
function MyPageNicknameModal({onCancelClick}:{onCancelClick: () => void}) {
    return (
        <div className={styles.container}>
            ...
            <form style={{width: '100%', flex: 1, paddingBottom: 40, display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexDirection: 'column'}}>
                <TextInput variant='field' title='닉네임 수정' maxLength={10} helperText='최대 10자까지 입력할 수 있어요' showFooter={true}/>
