export const REST_TITLE = '가볍게 산책하기';
export const REST_DESCRIPTION = '동네 한바퀴하면서 예쁜 하늘 사진 한장 어떠세요?';
export const ACTIVITY_PROGRESS_TITLE = '산책하고 사진 찍는중..';
export const ACTIVITY_PROGRESS_COUNT = '173';
